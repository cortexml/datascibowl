...
** DONE [#A] Dropout/maxout research
   CLOSED: [2015-03-08 Sun 15:34]
   :LOGBOOK:  
   ...
   - there's 2 places to see examples here
     ...
     see also, [[https://github.com/lisa-lab/pylearn2/tree/master/pylearn2/scripts/papers/maxout][maxout]], and [[https://github.com/lisa-lab/pylearn2/tree/master/pylearn2/scripts/papers/dropout][dropout]] examples
   - maxout is a model layer
   - dropout is a cost function, when used on a layer it is
     [[https://groups.google.com/forum/#!searchin/pylearn-users/dropout/pylearn-users/sT8efiUCMwY/mdlY0rAxPZsJ][applied everywhere]]
   - maxout (at least in 2013) only worked with SGD algorithm

   - Geoff Hinton, who came up multiple times at a dinner
     last night where 4/7 attendees were practicing machine
     learning, authored the widely recognized [[http://arxiv.org/pdf/1207.0580v1.pdf][paper on
     dropout]]. 
   - In simple terms, this prevents overfitting by omitting
     hidden features with probability 0.5 and some observed
     elements in each training case. The results is similar
     to averaging models over random samples of the
     observations, while requiring less resources to fit
     many models.
   - [[http://deeplearning.net/software/pylearn2/library/costs.html#module-pylearn2.costs.mlp.dropout][pylearn2.costs.mlp.dropout]]

   - dropout performs better under some constraints, which
     [[http://arxiv.org/pdf/1302.4389v4.pdf][maxout takes advantage of]], as found by Goodfellow et
     al
   - [[http://deeplearning.net/software/pylearn2/library/models.html#pylearn2.models.maxout.Maxout][pylearn2.models.maxout.Maxout]]
     - a hidden layer which does max pooling over groups of
       linear units
   - [[http://deeplearning.net/software/pylearn2/library/models.html#pylearn2.models.maxout.MaxoutConvC01B][pylearn2.models.maxout.MaxoutConvC01B]]
   - [[http://deeplearning.net/software/pylearn2/library/models.html#pylearn2.models.maxout.MaxoutLocalC01B][pylearn2.models.maxout.MaxoutLocalC01B]]

** DONE Research Learning rate/momentum
   CLOSED: [2015-03-08 Sun 18:20]
   :LOGBOOK:  
   - State "DONE"       from ""           [2015-03-08 Sun 18:20]
   :END:      
   - [[http://www.willamette.edu/~gorr/classes/cs449/momrate.html][here's]] a good overview
   - learning rate is the size of the jump taken in the
     parameter space and momentum accelerates the learning
     rate when the previous change in the weight update was
     in the same direction
   - as for the actual values, grid search? some standard?
     Something for another day.
** DONE Update theano
   CLOSED: [2015-03-08 Sun 18:21]
   :LOGBOOK:  
   - State "DONE"       from "NEXT"       [2015-03-08 Sun 18:21]
   - State "NEXT"       from ""           [2015-03-08 Sun 15:55]
   :END:      
   - /home/jotham/projects/2014-12-20_datascibowl/pylearn2_fork/pylearn2/sandbox/cuda_convnet/__init__.py:66:
     UserWarning: You are using probably a too old Theano
     version. That will cause compilation crash. If so,
     update Theano.
** DONE Run with dropout/maxout
   CLOSED: [2015-03-08 Sun 20:27]
   :LOGBOOK:  
   - State "DONE"       from "NEXT"       [2015-03-08 Sun 20:27]
   - State "NEXT"       from ""           [2015-03-08 Sun 15:55]
   :END:      
** DONE Improve sample/Augmentation [1/4]
   CLOSED: [2015-03-10 Tue 22:35]
   :LOGBOOK:  
   - State "DONE"       from "TODO"       [2015-03-10 Tue 22:35]
   :END:      
   - see 4.1 in [[http://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf][krizhevsky et al]]
*** DONE [#A] Resample training set to even obs/class
    CLOSED: [2015-03-10 Tue 22:35]
    :LOGBOOK:  
...
** DONE Continue learning
   CLOSED: [2015-03-08 Sun 18:24]
   :LOGBOOK:  
   - State "DONE"       from "TODO"       [2015-03-08 Sun 18:24]
   :END:      
   - furthermore, I see that the maxout examples use
     continued learning, what is this?
   - ah, i think it's used for if you want to interrupt
     learning or just after the stopping criterion is
     reached, this can be invoked to decide if learning
     should, guess ... continue!

** DONE try random transform via block and transformerdataset
   CLOSED: [2015-03-12 Thu 06:15]
   :LOGBOOK:  
   - State "DONE"       from ""           [2015-03-12 Thu 06:15]
   :END:      
   - miserable score
** DONE online augmentation
   CLOSED: [2015-03-12 Thu 08:53]
   :LOGBOOK:  
   ...
   - see the commit
** DONE try just rotation; no translations
   CLOSED: [2015-03-12 Thu 21:37]
   :LOGBOOK:  
   ...
   - when i reran visualization in
     random_transformation_tests_0 some of the images were just lack
   - and even without translations, sometimes the shape was
     pretty much absent from the image
** DONE Try transformations without class balancing
   CLOSED: [2015-03-12 Thu 21:39]
   :LOGBOOK:  
   - State "DONE"       from "NEXT"       [2015-03-12 Thu 21:39]
   - State "NEXT"       from ""           [2015-03-10 Tue 23:07]
   :END:      
   - [[https://www.kaggle.com/c/datasciencebowl/forums/t/12585/how-do-you-deal-with-the-class-unbalance-for-your-cnn-model][see here]], class balancing may be problematic
     
** DONE try random 90 deg warm online augmentation
   CLOSED: [2015-03-12 Thu 23:43]
   :LOGBOOK:  
...
** DONE try thr 3 orthogonal transform
   CLOSED: [2015-03-12 Thu 23:55]
   :LOGBOOK:  
...
** DONE Verify the 3 orthogonal rotations
   CLOSED: [2015-03-14 Sat 15:15]
   :LOGBOOK:  
   ...
   - it also requires some parameters other than rotate; i
     made some naive assumptions about how it works
** DONE Retry 3 orthogonal augmentations
   CLOSED: [2015-03-14 Sat 19:50]
   :LOGBOOK:  
...
** NEXT Parameter research
   ...
   - convolutional layers
     - http://deeplearning.net/software/pylearn2/library/models.html#id10
...
** TODO parameter grid search, see pylearn2-jobman from domulin
   - 

** DONE [#A] Retry 3 orthogonl augment with different model
   CLOSED: [2015-03-14 Sat 22:31]
   :LOGBOOK:  
...
** NEXT retry prediction on whole test set
   ...
   :END:      
   - with theano RC
   - otherwise, use iterator with larger pred batches, cause
     the individual is so slow
...
** TODO [#A] Validate the process for generating validation image and column labels
   ...
   - better investigate that failure to know how to avoid it
     next time
** TODO Review image proc [[http://scipy-lectures.github.io/packages/scikit-image/][presentation]]
** TODO simple BGD and SGD again on softmax again
   - using augmented data
   - on laptop
** TODO other stopping riles
   - epochs
   - other monitor costs
...
** Setup a few python dev env things for emacs
   - consider making it extensible to remote machines with
     just shell access
...
cusedit
ido mode
windowmove key bindings shift

yasnippet snippets for classes, r functions, for example

also very much need the package which fixes the
custom-set-variable bullshit
