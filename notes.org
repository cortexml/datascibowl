...
*** NEXT use larger images while we're at it, 48x48
    :LOGBOOK:  
    - State "NEXT"       from ""           [2015-03-07 Sat 13:47]
    :END:      
*** NEXT Rough planning
    :LOGBOOK:  
    - State "NEXT"       from ""           [2015-03-08 Sun 11:52]
    :END:      
    - we have the reader
    - the datascibowl class
      - add argument augment
    - in reader, if augment
    - if, for each image, we want to transform it what is needed?
      - the number of transformations to do ->

    - ...

    - it's on paper. see the commit.
