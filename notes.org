...
** DONE [#A] Get predictions on training set
...
** NEXT [#A] Setup validation set for prediction
   :LOGBOOK:  
...
** NEXT [#B] Get predictions on validation set and submit
   :LOGBOOK:  
...
** NEXT Research on CNN application
   :LOGBOOK:  
   ...
   - 
** Batch size, momentum optimization
   -
...
** TODO Implement the classifier cost function in monitoring
   :LOGBOOK:  
   - State "NEXT"       from ""           [2015-02-15 Sun 22:10]
   :END:      
   - 
