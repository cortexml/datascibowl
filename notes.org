...
** NEXT [#A] Shuffle the observations
   :LOGBOOK:  
...
** NEXT [#A] Predictions
   ...
   :END:      
   -
** NEXT [#A] train on all imgs, submit
   :LOGBOOK:  
   - State "NEXT"       from ""           [2015-02-15 Sun 22:28]
   :END:      
...
** TODO [#B] Get running on GPU/desktop
   -
** Even obs per class
** NEXT Implement the classifier cost function in monitoring
   :LOGBOOK:  
   - State "NEXT"       from ""           [2015-02-15 Sun 22:10]
   :END:      
   - 
** [[http://daemonmaker.blogspot.ca/2014/10/a-first-experiment-with-pylearn2.html][Pylearn2 models]] and [[http://deeplearning.net/software/pylearn2/library/index.html#libdoc][official docs]]
   ...
   - softmax parameters
     - batch
     - irange
** NEXT Understand the fitting monitor
   :LOGBOOK:  
...
** NEXT Fit more models/Combinations to try
   :LOGBOOK:  
   - State "NEXT"       from ""           [2015-02-15 Sun 22:14]
   :END:      
   - parameter space
