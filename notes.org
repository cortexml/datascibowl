...
*** TODO Pandas
    - 
*** TODO [[http://scikit-learn.org/stable/user_guide.html#user-guide][sci kit learn (user guide)]]
...
** TODO Settung up python dev on ArchLinux v2
...
** TODO Hu central moment expirimentation [0/3]
*** Features [1/2]
...
** [[https://docs.python.org/2/library/pickle.html][Pickle]] for saving python objects
