...
** NEXT [#A] Get running on GPU/desktop [2/3]
   :LOGBOOK:  
...
*** NEXT Troubleshoot theano on gpu
    :LOGBOOK:  
    - State "NEXT"       from ""           [2015-02-22 Sun 21:06]
    :END:      

Friggin laptop was faster, 400 instead of 600 seconds per
epoch. Neeeeed GPU to work.

** NEXT Test whole ipynb flow on desktop
   :LOGBOOK:  
...
** NEXT Don't hardcode path into datasetclass
   :LOGBOOK:  
   - State "NEXT"       from ""           [2015-02-22 Sun 21:21]
   :END:      
   - use pylearn_data_path
** NEXT change MonitorBasedSaveBest to use nll
   :LOGBOOK:  
